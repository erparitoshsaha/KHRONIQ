...
const TESTIMONIALS = [
  {
    name: 'Priya S.',
    location: 'Mumbai',
    text: 'Papa ke 60th birthday par Khroniq Crescent gift kiya tha. Unka reaction dekh kar dil khush ho gaya! Gift set ki packaging aur har detail ekdam perfect thi.',
    stars: 5,
  ...
  },
  {
    name: 'Arjun M.',
    location: 'Delhi',
    text: 'Wife ko ye Gentleman Blue bohot hi zyada pasand aayi. Custom engraving ki wajah se ye gift aur bhi khas ho gaya. Definitely again order karunga!',
    stars: 5,
  ...
  },
  {
    name: 'Rhea K.',
    location: 'Bengaluru',
    text: 'Mere mentor ke retirement par Luxury Gift Set order kiya tha. Iska presentation sach mei world-class hai. Khroniq ne saari expectations surpass kar di!',
    stars: 5,
