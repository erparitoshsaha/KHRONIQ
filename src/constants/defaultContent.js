// ============================================================================
// KHRONIQ CMS — DEFAULT CONTENT SECTIONS (100% Faithful to Existing Website)
// ============================================================================
...
export const DEFAULT_CONTENT_SECTIONS = [
  ...
  },
  {
    ...
    isActive: true,
    items: [
      { id: 'item-mqa-1', title: 'Premium & Luxury', order: 1, isActive: true },
      { id: 'item-mqa-2', title: 'Indian Engineered', order: 2, isActive: true },
      { id: 'item-mqa-3', title: '1 Year Premium Warranty', order: 3, isActive: true }
    ]
  },
  {
    id: 'sec-home-gender-split',
    page: 'home',
  ...
  },
  {
    ...
    isActive: true,
    items: [
      { id: 'item-mqb-1', title: 'True Knock Group Product', order: 1, isActive: true },
      { id: 'item-mqb-2', title: 'Limited Edition Masterpiece', order: 2, isActive: true },
      { id: 'item-mqb-3', title: 'Khroniq Caliber Craftsmanship', order: 3, isActive: true },
      { id: 'item-mqb-4', title: 'Excellence Redefined', order: 4, isActive: true },
      { id: 'item-mqb-5', title: 'State-of-the-Art Indian Manufacture', order: 5, isActive: true },
      { id: 'item-mqb-6', title: 'Precision Made in India', order: 6, isActive: true }
    ]
  },
  {
    id: 'sec-home-story',
  ...
  },
  {
    ...
    isActive: true,
    items: [
      { id: 'item-st-1', title: '100%', subtitle: 'Swadeshi Design', order: 1, isActive: true },
      { id: 'item-st-2', title: '2026', subtitle: 'Indian Launch', order: 2, isActive: true },
      { id: 'item-st-3', title: '50K+', subtitle: 'Pre-bookings', order: 3, isActive: true }
    ]
  },
  ...
  // ─── FAQ PAGE (faq) ───────────────────────────────────────────────────────
  {
    ...
    items: [
      { id: 'faq-1', order: 1, isActive: true, title: "What type of movement does KHRONIQ use?", description: "KHRONIQ watches are equipped with high-quality quartz movements designed to deliver accurate and reliable timekeeping." },
      { id: 'faq-2', order: 2, isActive: true, title: "Are KHRONIQ watches waterproof?", description: "KHRONIQ watches are water-resistant according to the rating specified for each model. Please refer to your watch's specifications before exposing it to water." },
      { id: 'faq-3', order: 3, isActive: true, title: "Can I wear my watch while swimming?", description: "Only watches specifically rated for swimming should be worn in water. Always check your model's water-resistance rating before swimming or participating in water activities." },
      { id: 'faq-4', order: 4, isActive: true, title: "Can I wear my watch while showering?", description: "No. Hot water, soap, shampoo, and steam may damage the seals and reduce water resistance over time." },
      { id: 'faq-5', order: 5, isActive: true, title: "How long does the battery last?", description: "Depending on the model and usage, the battery typically lasts between 2 to 5 years." },
      { id: 'faq-6', order: 6, isActive: true, title: "Can I replace the battery myself?", description: "No. Battery replacement should only be carried out by KHRONIQ or an authorized service centre to maintain product integrity and water resistance." },
      { id: 'faq-7', order: 7, isActive: true, title: "Why has my watch stopped working?", description: "Possible reasons include battery depletion, impact damage, water damage, or internal movement malfunction. If your watch stops unexpectedly, please contact KHRONIQ Customer Support." },
      { id: 'faq-8', order: 8, isActive: true, title: "Why is my watch gaining or losing a few seconds?", description: "Minor variations in quartz timekeeping are normal and fall within accepted industry standards." },
      { id: 'faq-9', order: 9, isActive: true, title: "Can I adjust the date at any time?", description: "No. Do not adjust the date between 9:00 PM and 3:00 AM, as this may damage the date-change mechanism." },
      { id: 'faq-10', order: 10, isActive: true, title: "Can I wear my watch while sleeping?", description: "Although it is possible, removing your watch while sleeping can help reduce unnecessary wear on the strap and case." },
      { id: 'faq-11', order: 11, isActive: true, title: "How do I clean my watch?", description: "Use a soft microfiber cloth to gently clean the watch. Avoid abrasive cleaners, harsh chemicals, or polishing compounds." },
      { id: 'faq-12', order: 12, isActive: true, title: "Can leather straps get wet?", description: "Leather straps should be kept away from excessive moisture. If they become wet, dry them naturally and avoid direct heat." },
      { id: 'faq-13', order: 13, isActive: true, title: "Can I replace the strap?", description: "Yes. Most KHRONIQ watches support compatible replacement straps. We recommend using genuine KHRONIQ straps whenever available." },
      { id: 'faq-14', order: 14, isActive: true, title: "Does the warranty cover accidental damage?", description: "No. The warranty covers manufacturing defects only and does not cover accidental damage, misuse, normal wear and tear, battery depletion, or unauthorized repairs." },
      { id: 'faq-15', order: 15, isActive: true, title: "What should I do if my watch arrives damaged?", description: "If your watch arrives damaged or the package appears tampered with, contact KHRONIQ within 24 hours of delivery and provide photographs of the product and packaging." },
      { id: 'faq-16', order: 16, isActive: true, title: "How can I verify that my watch is genuine?", description: "Purchase only from KHRONIQ or an authorized dealer. Verify the serial number or QR code, where applicable, and retain your original purchase invoice." },
      { id: 'faq-17', order: 17, isActive: true, title: "Can I return my watch?", description: "Returns are accepted only in accordance with the KHRONIQ Return & Refund Policy. Please review the policy on our Website for eligibility and conditions." },
      { id: 'faq-18', order: 18, isActive: true, title: "How can I claim my warranty?", description: "Contact KHRONIQ Customer Support with your purchase invoice, warranty card, watch serial number (if applicable), and photographs or videos showing the issue. Our team will guide you through the warranty claim process." },
      { id: 'faq-19', order: 19, isActive: true, title: "Do I need to register my warranty?", description: "Warranty registration may be available for selected models. Even if registration is optional, we recommend completing it for faster service and product verification." },
      { id: 'faq-20', order: 20, isActive: true, title: "Can I repair my watch at any local shop?", description: "No. Repairs should only be performed by KHRONIQ or an authorized service centre. Unauthorized repairs may void your warranty." },
      { id: 'faq-21', order: 21, isActive: true, title: "Are replacement parts genuine?", description: "Yes. KHRONIQ uses genuine replacement parts for approved warranty and service repairs, subject to availability." },
      { id: 'faq-22', order: 22, isActive: true, title: "Do watch colours look exactly the same as shown online?", description: "We strive to display products accurately. However, slight differences in colour or finish may occur due to screen settings, lighting, and photography." },
      { id: 'faq-23', order: 23, isActive: true, title: "Do you offer gift wrapping?", description: "Yes, premium gift packaging may be available for eligible products during checkout." },
      { id: 'faq-24', order: 24, isActive: true, title: "Can I cancel my order?", description: "Orders can generally be cancelled only before dispatch. Once shipped, the order is subject to the applicable Return & Refund Policy." },
      { id: 'faq-25', order: 25, isActive: true, title: "How long does delivery take?", description: "Estimated delivery timelines are: Metro Cities 2–5 business days, Tier-2 & Tier-3 Cities 3–7 business days, Remote Areas 5–10 business days. Actual delivery times may vary due to logistics or Force Majeure events." },
      { id: 'faq-26', order: 26, isActive: true, title: "How can I contact KHRONIQ Customer Support?", description: "Email: support@khroniq.com. Our Customer Support team will be happy to assist you with product information, warranty claims, order tracking, returns, servicing, and general enquiries." }
    ]
  },
  ...
  // ─── NAVIGATION (navigation) ───────────────────────────────────────────────
  {
    ...
    isActive: true,
    items: [
      { id: 'nav-1', title: 'HOME', buttonLink: 'home', order: 1, isActive: true },
      { id: 'nav-2', title: 'MEN', buttonLink: 'shop', metadata: { filter: { gender: 'men' } }, order: 2, isActive: true },
      { id: 'nav-3', title: 'WOMEN', buttonLink: 'shop', metadata: { filter: { gender: 'women' } }, order: 3, isActive: true },
      { id: 'nav-4', title: 'SHOP ALL', buttonLink: 'shop', metadata: { filter: { shopAll: true } }, order: 4, isActive: true },
      { id: 'nav-5', title: 'CUSTOMIZE', buttonLink: 'customization', order: 5, isActive: true },
      { id: 'nav-6', title: '🎁 GIFTING', buttonLink: 'gifting', metadata: { megaMenu: true }, order: 6, isActive: true }
    ]
  },

  // ─── POLICIES ─────────────────────────────────────────────────────────────
  {
    id: 'sec-terms-overview',
    page: 'terms',
