...
export const DEFAULT_LOCATIONS = [
  ...
  { id: 'loc-delhi', name: 'Delhi Store (NCR)' },
  { id: 'loc-mumbai', name: 'Mumbai Store' },
  { id: 'loc-bengaluru', name: 'Bengaluru Store' },
  { id: 'loc-hyderabad', name: 'Hyderabad Store' },
  { id: 'loc-chennai', name: 'Chennai Store' },
  { id: 'loc-kolkata', name: 'Kolkata Store' },
  { id: 'loc-pune', name: 'Pune Store' },
  { id: 'loc-ahmedabad', name: 'Ahmedabad Store' },
  { id: 'loc-jaipur', name: 'Jaipur Store' },
  { id: 'loc-chandigarh', name: 'Chandigarh Store' },
  { id: 'loc-lucknow', name: 'Lucknow Store' },
  { id: 'loc-surat', name: 'Surat Store' },
  { id: 'loc-kochi', name: 'Kochi Store' },
  { id: 'loc-goa', name: 'Goa Store' },
  { id: 'loc-indore', name: 'Indore Store' },
  { id: 'loc-bhopal', name: 'Bhopal Store' },
  { id: 'loc-vadodara', name: 'Vadodara Store' },
  { id: 'loc-nagpur', name: 'Nagpur Store' },
  { id: 'loc-coimbatore', name: 'Coimbatore Store' },
  { id: 'loc-visakhapatnam', name: 'Visakhapatnam Store' },
  { id: 'loc-patna', name: 'Patna Store' },
  { id: 'loc-guwahati', name: 'Guwahati Store' },
  { id: 'loc-bhubaneswar', name: 'Bhubaneswar Store' },
  { id: 'loc-ludhiana', name: 'Ludhiana Store' },
  { id: 'loc-agra', name: 'Agra Store' },
  { id: 'loc-varanasi', name: 'Varanasi Store' },
  { id: 'loc-dehradun', name: 'Dehradun Store' },
  { id: 'loc-london', name: 'London Flagship' },
  { id: 'loc-dubai', name: 'Dubai Boutique' },
  { id: 'loc-tokyo', name: 'Tokyo Boutique' },
  { id: 'loc-newyork', name: 'New York Flagship' },
  { id: 'loc-geneva', name: 'Geneva Atelier' },
  { id: 'loc-paris', name: 'Paris Boutique' },
  { id: 'loc-singapore', name: 'Singapore Hub' },
];
