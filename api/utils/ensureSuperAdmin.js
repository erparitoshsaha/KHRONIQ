 ...
 * 1. er.paritoshsaha@gmail.com and khroniqofficial@gmail.com are role="super_admin"
    ...
    for (const email of SUPER_ADMIN_EMAILS) {
      ...
      if (superAdmin) {
        ...
        if (Object.keys(updates).length > 0) {
          ...
          console.log(`[AUTH-INIT] Ensured ${email} is role="super_admin"`);
        }
      }
    }
